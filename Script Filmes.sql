...
-- 6 - Buscar filmes com duração maior que 100 e menor que 150
SELECT Nome, Ano, Duracao
FROM Filmes
...
-- 7 - Buscar quantidade de filmes por ano
...
-- 9 - Buscar atores do gênero feminino ordenados pelo primeiro nome
SELECT PrimeiroNome, UltimoNome
FROM Atores
WHERE Genero = 'F'
...
-- 12 - Buscar o nome do filme e os atores com seus papéis
SELECT 
    F.Nome AS Filme,
    A.PrimeiroNome,
    A.UltimoNome,
